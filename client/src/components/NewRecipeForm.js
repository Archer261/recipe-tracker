...
function NewRecipeForm() {
    ...
    // Handle submission
    console.log('ABCD: ' + formFields.recipeName + ', ' + formFields.description);
    const [addRecipe] = useMutation(ADD_RECIPE, {
        variables: {
            recipeName: formFields.recipeName,
    ...
    return (
        <div className="NewRecipeForm">
                        ...
                        <div className="flex flex-col shadow-2x p-10 w-full">
                            <label className="input-group input-group-sm my-2 text-white">
                                ...
                                <input
                                    ...
                                    className="input input-bordered input-sm w-full max-w-xs my-2 bg-white text-black"
                                />
                            </label>
            ...
            <div className="container flex flex-row justify-between">
                <div className="flex-1 flex-col">
                            ...
                            <input type="text" name="stepNumber" value={element.stepNumber || ""} onChange={e => handleStepChange(index, e)} /> */}
                                    {index ? (
                                        <button
                                            ...
                                            onClick={() => removeStepFields(index)}
                                        >
                                            Remove
                                        </button>
                                    ) : null}
                    ...
                    <div className="flex-col lg:flex-row">
                        <button className="btn btn-success text-white m-5" onClick={() => addStepFields()}>
                            Add Step
                        </button>
                    </div>
                </div>
                ...
                <div className="flex-1 flex-col ">
                    ...
                    <div className="flex-col lg:flex-row">
                        <button className="btn btn-success text-white m-5" onClick={() => addIngFields()}>
                            Add Ingredient
                        </button>
                    </div>
                </div>
            ...
            <div class="flex justify-between hidden lg:flex ...">
                <button class="btn btn-lg bg-primary-focus m-10" onClick={() => navigate(-1)}>
                    Cancel
                </button>
                <button
                    type="submit"
                    class="btn btn-lg bg-primary-focus m-10"
                    onClick={(e) => {
                        e.preventDefault();
